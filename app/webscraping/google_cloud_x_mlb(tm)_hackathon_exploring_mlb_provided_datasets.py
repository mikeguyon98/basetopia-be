# -*- coding: utf-8 -*-
"""Google Cloud x MLB(TM) Hackathon: Exploring MLB Provided Datasets.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1QcZD-_VK-Fa9ZC_iNy6Cth0n67KF2dSC
...
leagues_endpoint_url = 'https://statsapi.mlb.com/api/v1/league?sportId=1'
...
# display(teams)
print(teams.columns)
columns_to_display = ['id', 'name', 'abbreviation', 'locationName', 'link', 'teamCode', 'sport_id',
       'sport_link', 'sport_name']
display(teams[columns_to_display])

""":"""

inactive_teams = teams[teams['active'] == False]
display(inactive_teams)
